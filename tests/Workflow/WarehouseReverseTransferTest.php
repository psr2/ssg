...
class WarehouseReverseTransferTest extends TestCase
{
    use RefreshDatabase;
    ...
    /**
     * Test warehouse-to-warehouse stock transfer followed by a reverse transfer.
     */
    public function test_warehouse_reverse_stock_transfer(): void
    {
        ...
        // 6. Assert all 5 expected ledger entries are logged correctly:
