<div class="modal fade" id="edit_new_unit" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header" style="background-color: rgb(3, 3, 61);color:white;">
                <h5 class="modal-title modal-h1" id="staticBackdropLabel">Update New Unit <i
                ...
                <form method="POST" action="/create-unit" id="unit_form">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-12">
                            ...
                            <input type="text" class="form-control" id="edit_abbreviation" name="edit_abbreviation"
            ...
            <div class="modal-footer">
                ...
                <button type="button submit" class="btn btn-primary ">Update</button>
                </form>
            </div>
        </div>
    </div>
