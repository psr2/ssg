...
class PurchaseReferenceNumberGenerator
{
    const REFERENCE_NUMBER_PREFIX = 'PRCH';

    /**
     * Generate unique purchase reference number.
     * Tech debt:: generate reference number  by swoole aysnc
     * Move const to a new config file in module if possible later at some point
     *
     * @return string
     */
